...
# is upper triangular with empty diagonal: add diagonal, fill lower triangle, convert to matrix
...
# use a copula to generate multivariate beta observation
